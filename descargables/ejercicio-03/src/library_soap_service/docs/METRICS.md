...
**Tiempo de desarrollo:** aproximadamente **15 horas** repartidas en 3
sesiones — (1) diseño y congelado del contrato WSDL/XSD, (2) implementación
del servidor (envelope manual, service, queries, SQL) y del cliente SOAP,
(3) pruebas, interoperabilidad con `zeep` e integración al repo del monolito.
...
| Pruebas (Python) | `tests/test_app.py`, `tests/test_operaciones_e2e.py` | **308** |
